...
const strings = {
  ...
  es: {
    ...
    "pricing.basic.title":"Clase Introductoria",
    ...
    "pricing.monthly.title":"Subscripcion Mensual (4)",
    "pricing.monthly.note":"($110/clase)",
    "pricing.monthly.l1":"4 clases privadas (1 hr c/u)",
    "pricing.monthly.l2":"Expira en 365 días",
    "pricing.monthly.l3":"Grabaciones de práctica",

    "pricing.full.title":"Curso Completo (16)",
