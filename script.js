...
const strings = {
  en: {
    ...
    "group_classes.offer.l2":"Introduction to bomba instruments:<ul><li>barril (1 class)</li><li>maraca (1 class)</li><li>cuá (1 class)</li></ul>",
    "group_classes.offer.l3":"Introduction to basic playing technique for each bomba instrument",
    "group_classes.offer.l4":"Fundamental barril sounds in Yubá:<ul><li>abierto</li><li>caja</li></ul>",
    "group_classes.offer.l5":"One selected Yubá variation on barril (1 class):<ul><li>masón</li><li>cuartiao</li><li>leró</li></ul>",
  ...
  es: {
    ...
    "group_classes.offer.l2":"Introducción a los instrumentos de la bomba:<ul><li>barril (1 clase)</li><li>maraca (1 clase)</li><li>cuá (1 clase)</li></ul>",
    "group_classes.offer.l3":"Introducción a técnicas básicas de toque para cada instrumento de la bomba",
    "group_classes.offer.l4":"Sonidos fundamentales del barril en yubá:<ul><li>abierto</li><li>caja</li></ul>",
    "group_classes.offer.l5":"Selección de una variación de yubá en barril (1 clase):<ul><li>masón</li><li>cuartiao</li><li>leró</li></ul>",
