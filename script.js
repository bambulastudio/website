...
const strings = {
  en: {
    ...
    "popover.percussion.intermediate.monthly": "Includes:<ul>\n      <li>3 classes of a single rhythm (choose one from sicá, yubá, cuembé, holandé, or calindá)</li>\n      <li>1 class: review of all learned rhythms</li>\n    </ul>",
    ...
    "popover.percussion.advanced.monthly": "Includes:<ul>\n      <li>3 classes of a single rhythm (choose one from sicá, yubá, cuembé, holandé, calindá, corvé, or seis corrido)</li>\n      <li>1 class: review of all learned rhythms</li>\n    </ul>",
  ...
  es: {
    ...
    "popover.percussion.intermediate.monthly": "Incluye:<ul>\n      <li>3 clases de el ritmo escogido para la clase (a elegir entre entre sicá, yubá, cuembé, holandé o calindá)</li>\n      <li>1 clase: revisión de todos los ritmos aprendidos</li>\n    </ul>",
    ...
    "popover.percussion.advanced.monthly": "Incluye:<ul>\n      <li>3 clases de un ritmo (a elegir entre sicá, yubá, cuembé, holandé, calindá, corvé o seis corrido)</li>\n      <li>1 clase: revisión de todos los ritmos aprendidos</li>\n    </ul>",
    ...
    "popover.dance.intermediate.monthly": "Incluye:<ul>\n      <li>3 clases de el ritmo escogido para la clase (a elegir entre sicá, yubá, cuembé, holandé o calindá)</li>\n      <li>1 clase: revisión de todos los ritmos aprendidos</li>\n    </ul>",
