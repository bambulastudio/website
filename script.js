...
const strings = {
  en: {
    ...
    "explore.waitlist.title":"Waitlist or Contact",
    "explore.waitlist.body":"If you are interested but not ready to commit yet, join the waitlist or send a question first.",
    ...
    "waitlist.title":"Not ready to book yet? Join the waitlist.",
    "waitlist.lead":"Share your availability and interests. When a time slot reaches quorum, we’ll email you with dates and next steps. No payment now, just interest.",
    "form.name":"Name",
    "form.email":"Email",
    "form.msg":"Message",
    "form.send":"Send",
  ...
  es: {
    ...
    "explore.waitlist.title":"Lista de espera o contacto",
    "explore.waitlist.body":"Si te interesa, pero aún no quieres comprometerte, únete a la lista de espera o envía una pregunta primero.",
    ...
    "waitlist.title":"¿Aún no estás lista/o para reservar? Únete a la lista de espera.",
    "waitlist.lead":"Comparte tu disponibilidad e intereses. Cuando una franja horaria alcance el mínimo, te escribiremos con fechas y próximos pasos. No hay pago ahora, solo interés.",
    "form.name":"Nombre",
    "form.email":"Correo",
    "form.msg":"Mensaje",
    "form.send":"Enviar",
