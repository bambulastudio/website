...
function installPriceCardPopovers(){
  ...
  if (typeof installLevelInfoPopovers === 'function') {
    try { installLevelInfoPopovers(); } catch(_){ }
  }
  let dlg = document.querySelector('dialog.level-info');
  if (!dlg){
    // Create a dialog with the same class so it picks up existing styles
  ...
  // For each price card, add a tiny info trigger once
  document.querySelectorAll('.price-card').forEach(card => {
    ...
    btn.onclick = ()=>{
      ...
      const richHTML = map[popKey];

      // Render priority: i18n richHTML > hidden .popover-content > clone UL
      sheet.innerHTML = '';
      if (richHTML && typeof richHTML === 'string') {
        sheet.innerHTML = richHTML;
      } else if (card.querySelector(':scope > .popover-content')) {
        sheet.innerHTML = card.querySelector(':scope > .popover-content').innerHTML;
      } else {
        ...
        if (list){
          list.querySelectorAll(':scope > li').forEach(li => {
            ...
            clone.textContent = (li.textContent || '').trim();
            newUl.appendChild(clone);
          });
        } else {
          const none = document.createElement('div');
          none.textContent = (lang==='es') ? 'Sin detalles adicionales.' : 'No additional details.';
...
const strings = {
  en: {
    ...
    "nav.about":"About",
    "nav.classes":"Classes",
    "nav.group_classes":"Group Classes",
    ...
    "explore.eyebrow":"Start here",
    "explore.title":"Explore the site by what you need",
    "explore.lead":"Whether you are looking for private study, institutional programming, or a first look at the work, these are the fastest ways in.",
    "explore.classes.title":"Private Classes",
    "explore.classes.body":"Browse percussion or dance offerings, compare levels, and see which format fits your pace.",
    "explore.classes.cta":"Go to classes",
    "explore.group_classes.title":"Group Classes",
    "explore.group_classes.body":"See the current group series and join the waitlist for upcoming shared-learning offerings.",
    "explore.group_classes.cta":"View group classes",
    ...
    "group_classes.p1":"Offerings rotate by rhythm, instrument, and focus area, with guided practice and ensemble awareness built into each session.",
    ...
    "group_classes.offer.l2":"Introduction to bomba instruments: barril (1 class), maraca (1 class), cuá (1 class)",
    "group_classes.offer.l3":"Introduction to basic playing technique for each bomba instrument",
    "group_classes.offer.l4":"Fundamental barril sounds in Yubá: abierto, caja",
    "group_classes.offer.l5":"One selected Yubá variation on barril (1 class): masón, cuartiao, or leró",
    ...
    "explore.workshops.body":"See workshop formats, outcomes, and inquiry details for campuses and organizations.",
    "explore.workshops.cta":"View workshops",
    "explore.gallery.title":"Gallery",
    "explore.gallery.body":"Open videos and community moments if you want a quick feel for the work before reading more.",
    "explore.gallery.cta":"Open gallery",
    "explore.waitlist.title":"Waitlist",
    "explore.waitlist.body":"Interested in future openings? Join the waitlist and we will reach out when a suitable time slot opens.",
    "explore.waitlist.cta":"Join waitlist",
    ...
    "pricing.basic.monthly.title":"4-Class Pack",
    ...
    "pricing.basic.full.title":"16-Class Pack",
    ...
    "pricing.intermediate.monthly.title":"4-Class Pack",
    "pricing.intermediate.full.title":"16-Class Pack",

    // ADVANCED – section titles for monthly/full cards
    "pricing.advanced.monthly.title":"4-Class Pack",
    "pricing.advanced.full.title":"16-Class Pack",
    "pricing.cta":"Book",
    ...
    // Intermediate single
    "pricing.intermediate.single.title":"Single Class",
    "pricing.intermediate.single.note":"If you enroll in the 16-Class Pack within 30 days from booking, this session is credited.",
    ...
    "pricing.advanced.single.note":"If you enroll in the 16-Class Pack within 30 days from booking, this session is credited.",
    ...
    "workshops.title":"Institutional Workshops",
    "workshops.p1":"Programs for universities, colleges, and institutions: lecture-demonstrations, hands-on residencies, and culturally grounded talks in Puerto Rican Bomba.",
    "workshops.p2":"Ideal for music, dance, Latinx/Caribbean studies, cultural competency trainings, and chapels. Content adapts to course outcomes and audience level.",
    "workshops.cta":"Inquire for dates",
    "workshops.eyebrow":"For campuses & institutions",
    "workshops.format1":"Lecture-demo · 60–90 minutes",
    "workshops.format2":"Hands-on workshop · 2–3 hours",
    "workshops.format3":"Residency or multi-day series · tailored",
    "workshops.pricingNote":"Custom pricing based on scope, duration, and travel. Inquire for a tailored proposal.",
    "workshops.includes":"Sample Outcomes",
    "workshops.factorsTitle":"What affects pricing",
    "workshops.f1":"Duration: 1-hour lecture demo to multi-day residency",
    "workshops.f2":"Format: hands-on vs lecture-only",
    "workshops.f3":"On-site needs: space, sound, equipment",
    "workshops.f4":"Travel and lodging",
    "workshops.f5":"Audience size and goals",
    "workshops.i1":"Lecture-demo: history, rhythm family (sicá, yubá, cuembé, holandé), call-and-response",
    "workshops.i2":"Hands-on: basic step/paseo, ensemble coordination, cultural context",
    "workshops.i3":"Residency options: multi-day modules, culminating share or performance",
    "workshops.i4":"Audience: students, faculty, and community partners",
    "workshops.i5":"Logistics: on-site space, sound, and travel coordination",
    ...
    "contact.p1":"Have a question about classes, workshops, or availability? Send a message and we will get back to you directly.",
    "waitlist.title":"Join the waitlist",
    "waitlist.lead":"Interested in future openings? Share your availability and interests, and we will reach out when a suitable time slot opens. No payment now, just interest.",
    "form.name":"Name",
    "form.email":"Email",
    "form.msg":"Message",
    "form.send":"Send",
  ...
  es: {
    ...
    "popover.percussion.basic.monthly": "Incluye:<ul>\n      <li>3 horas contacto de sicá, yubá, cuembé u holandé (escoge uno)</li>\n      <li>1 clase: revisión/refuerzo de lo aprendido</li>\n    </ul>",
    ...
    "popover.percussion.intermediate.monthly": "Incluye:<ul>\n      <li>3 horas contacto de sicá, yubá, cuembé, holandé o calindá (escoge uno)</li>\n      <li>1 clase: revisión/refuerzo de lo aprendido</li>\n    </ul>",
    ...
    "popover.percussion.advanced.monthly": "Incluye:<ul>\n      <li>3 horas contacto de sicá, yubá, cuembé, holandé, calindá, corvé o seis corrido (escoge uno)</li>\n      <li>1 clase: revisión/refuerzo de lo aprendido</li>\n    </ul>",
    ...
    "nav.about":"Acerca",
    "nav.classes":"Clases",
    "nav.group_classes":"Clases grupales",
    ...
    "explore.eyebrow":"Empieza aquí",
    "explore.title":"Explora el sitio según lo que buscas",
    "explore.lead":"Ya sea que busques estudio privado, programación institucional o una primera mirada al trabajo, estas son las entradas más rápidas.",
    "explore.classes.title":"Clases privadas",
    "explore.classes.body":"Mira las opciones de percusión o baile, compara niveles y encuentra el formato que mejor se ajuste a tu ritmo.",
    "explore.classes.cta":"Ir a clases",
    "explore.group_classes.title":"Clases grupales",
    "explore.group_classes.body":"Mira la serie grupal actual y únete a la lista de espera para próximas ofertas de aprendizaje compartido.",
    "explore.group_classes.cta":"Ver clases grupales",
    ...
    "group_classes.p1":"Las ofertas rotan por ritmo, instrumento y enfoque, con práctica guiada y conciencia de conjunto en cada sesión.",
    ...
    "group_classes.offer.l2":"Introducción a los instrumentos de la bomba: barril (1 clase), maraca (1 clase), cuá (1 clase)",
    "group_classes.offer.l3":"Introducción a técnicas básicas de toque para cada instrumento de la bomba",
    "group_classes.offer.l4":"Sonidos fundamentales del barril en yubá: abierto, caja",
    "group_classes.offer.l5":"Selección de una variación de yubá en barril (1 clase): masón, cuartiao o leró",
    ...
    "explore.workshops.body":"Revisa formatos, resultados e información de consulta para campus y organizaciones.",
    "explore.workshops.cta":"Ver talleres",
    "explore.gallery.title":"Galería",
    "explore.gallery.body":"Abre videos y momentos comunitarios si quieres sentir el trabajo antes de leer más.",
    "explore.gallery.cta":"Abrir galería",
    "explore.waitlist.title":"Lista de espera",
    "explore.waitlist.body":"¿Te interesan futuras aperturas? Únete a la lista de espera y te escribiremos cuando se abra un horario adecuado.",
    "explore.waitlist.cta":"Unirme a la lista",
    ...
    "pricing.basic.monthly.title":"a fuego (4 clases)",
    ...
    "pricing.basic.full.title":"fiebrú (16 clases)",
    ...
    "pricing.intermediate.single.note":"Si te inscribes en el Paquete fiebrú dentro de los 30 días posteriores a la reserva, esta sesión se acredita.",
    ...
    "pricing.advanced.single.note":"Si te inscribes en el Paquete fiebrú dentro de los 30 días posteriores a la reserva, esta sesión se acredita.",
    ...
    "pricing.advanced.monthly.title":"a fuego (4 clases)",
    "pricing.advanced.price4":"$479 ($120/clase)",
    "pricing.advanced.price1":"$130",
    "pricing.advanced.full.title":"fiebrú (16 clases)",
    ...
    "workshops.p2":"Ideales para música, danza, estudios Latinx/Caribe, entrenamientos de competencia cultural, y capillas. El contenido se adapta a los resultados del curso y al nivel del público.",
    "workshops.cta":"Consultar fechas",
    "workshops.eyebrow":"Para campus e instituciones",
    "workshops.format1":"Conferencia-demostración · 60–90 minutos",
    "workshops.format2":"Taller práctico · 2–3 horas",
    "workshops.format3":"Residencia o serie de varios días · a medida",

    "workshops.pricingNote":"Precio personalizado según alcance, duración y viaje. Solicita una propuesta.",
    "workshops.includes":"Resultados de aprendizaje (ejemplos)",
    "workshops.factorsTitle":"¿Qué influye en el precio?",
    "workshops.f1":"Duración: desde 1 hora (conferencia-demostración) hasta residencia de varios días",
    "workshops.f2":"Formato: práctico vs solo conferencia",
    "workshops.f3":"Necesidades en sitio: espacio, sonido y equipo",
    "workshops.f4":"Viaje y estadía",
    "workshops.f5":"Tamaño del público y objetivos",
    "workshops.i1":"Conferencia-demostración: historia, familia rítmica (sicá, yubá, cuembé, holandé), llamado y respuesta",
    "workshops.i2":"Práctico: paso básico/paseo, coordinación en conjunto, contexto cultural",
    "workshops.i3":"Residencias: módulos de varios días, muestra o presentación final",
    "workshops.i4":"Públicos: estudiantes, facultad y socios comunitarios",
    "workshops.i5":"Logística: espacio, sonido y coordinación de viaje",
    ...
    "contact.p1":"¿Tienes preguntas sobre clases, talleres o disponibilidad? Envíanos un mensaje y te responderemos directamente.",
    "waitlist.title":"Únete a la lista de espera",
    "waitlist.lead":"¿Te interesan futuras aperturas? Comparte tu disponibilidad e intereses, y te escribiremos cuando se abra un horario adecuado. No hay pago ahora, solo interés.",
    "form.name":"Nombre",
    "form.email":"Correo",
    "form.msg":"Mensaje",
    "form.send":"Enviar",
